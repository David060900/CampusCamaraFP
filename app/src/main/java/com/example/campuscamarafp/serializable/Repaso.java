...
public class Repaso implements Serializable {
    ...
    //constructor
    public Repaso(String asignatura, String tiempo, String lugar, String dia, String correo_alumnos, int id_impartir) {
    ...
    public Repaso(String asignatura, String correo_alumnos, String dia, String tiempo) {
        this.asignatura = asignatura;
        this.tiempo = tiempo;
        this.dia = dia;
        this.correo_alumnos = correo_alumnos;
