...
public class AdminSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public void cargarDatos(SQLiteDatabase db){
        ...
        db.execSQL("insert into modulo values (6,'PLMK');");
        //inserts a curso
